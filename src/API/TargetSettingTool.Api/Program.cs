...
using TargetSettingTool.Api.Middleware;
using TargetSettingTool.Application;
using TargetSettingTool.Application.Contracts;
using TargetSettingTool.Infrastructure;
using TargetSettingTool.Persistence;
using TargetSettingTool.Identity;
using TargetSettingTool.Api.Services;
using TargetSettingTool.Api.Extensions;
using Microsoft.Extensions.Options;
using Swashbuckle.AspNetCore.SwaggerGen;
using TargetSettingTool.Api.SwaggerHelper;
