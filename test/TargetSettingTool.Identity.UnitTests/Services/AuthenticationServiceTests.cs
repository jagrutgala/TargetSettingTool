using TargetSettingTool.Application.Models.Authentication;
using TargetSettingTool.Identity.Services;
using TargetSettingTool.Identity.UnitTests.Fakes;
using TargetSettingTool.Identity.UnitTests.Mocks;
...
namespace TargetSettingTool.Identity.UnitTests.Services
{
